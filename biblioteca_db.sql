...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Set-2026 às 14:34
...
(2, 'O Cortiço', 'Aluísio Azevedo', 1890, 0),
(3, 'Memórias Póstumas de Brás Cubas', 'Machado de Assis', 1881, 0),
(4, 'Vidas Secas', 'Graciliano Ramos', 1938, 0),
(5, 'Capitães da Areia', 'Jorge Amado', 1937, 0);
